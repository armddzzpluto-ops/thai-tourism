...
- Smart Trip Assistant แบบครบขั้นตอน เลือกภูมิภาค จำนวนวัน ผู้เดินทาง ความสนใจ จังหวะเที่ยว และงบได้ พร้อมแผนรายวัน บันทึกในเบราว์เซอร์ พิมพ์ และส่งต่อเข้าเครื่องคำนวณงบ โดยไม่ใช้ API ภายนอก
...
| Trip planner (`#promotions`) | สร้างแผนรายวันจากแบบฟอร์มหรือข้อความ บันทึก/แก้ไข/พิมพ์แผน ดูแหล่งอ้างอิง และคำนวณงบจากตัวเลขที่ผู้ใช้กรอก |
