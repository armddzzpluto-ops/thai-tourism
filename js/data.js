...
const DESTINATIONS = [
  ...
  { id: 9, name: "Khao Yai", province: "Nakhon Ratchasima", region: "northeast", category: "nature", rating: 4.5, reviews: 1234, tourists: "1.5M", price: "฿400",
...
function normalizeDestinationSchema(destination) {
  ...
  destination.img = provinceImagePath;
...
/* ---------- CATEGORIES ---------- */
const CATEGORIES = [
  { key: "beach",    label: "ทะเล",      icon: "🏖️" },
  { key: "island",   label: "เกาะ",      icon: "🏝️" },
  { key: "mountain", label: "ภูเขา",     icon: "⛰️" },
  { key: "waterfall",label: "น้ำตก",     icon: "💧" },
  { key: "temple",   label: "วัด",       icon: "⛩️" },
  { key: "nature",   label: "ธรรมชาติ", icon: "🌿" }
];

/* ---------- REGIONS (for interactive map) ---------- */
const REGIONS = [
  { key: "north",     label: "ภาคเหนือ",      icon: "⛰️", provinces: "เชียงใหม่ · เชียงราย · น่าน" },
  { key: "central",   label: "ภาคกลาง",       icon: "🏛️", provinces: "กรุงเทพฯ · สุโขทัย · นครราชสีมา" },
  { key: "northeast", label: "ภาคอีสาน",      icon: "🌾", provinces: "อุบลราชธานี · ขอนแก่น · อุดรธานี" },
  { key: "east",      label: "ภาคตะวันออก",  icon: "🌊", provinces: "ชลบุรี · ระยอง · ตราด" },
