...
(function () {
  ...
  staticPairs.unshift(["ตัวกรองภูมิภาค", "Region filters"]);

  staticPairs.push(
    ["แล้วหรือยัง?", "yet?"],
    ["ขอบเขตข้อมูลโปรเจกต์", "Project data coverage"],
    ["ค้นหาสถานที่ท่องเที่ยวที่คุณสนใจ", "Search for a destination"],
    ["จังหวัดที่ตรวจสอบสถานที่แล้ว", "provinces with verified attractions"],
    ["ภาพที่เชื่อมกับข้อมูล", "images linked to the dataset"],
    ["รายการโปรด (0)", "Favorites (0)"],
    ["วางแผนก่อนเดินทาง", "Plan before you travel"],
    ["คำแนะนำการเดินทาง", "Tips & Guide"],
    ...
    ["ทริปไทย", "assistant"],
    ["ผู้ช่วยวางแผนทริปอัจฉริยะ", "Smart Trip Assistant"],
    ["เลือกภูมิภาค จำนวนวัน ผู้เดินทาง ความสนใจ และจังหวะการเที่ยว เพื่อสร้างแผนรายวันที่บันทึกไว้ในอุปกรณ์และนำไปคำนวณงบต่อได้", "Choose a region, trip length, travellers, interests and pace to build a day-by-day plan that is saved on your device and ready for budgeting."],
    ...
    ["ขั้นตอนที่ 1", "Step 1"],
    ["กำหนดทริปของคุณ", "Set up your trip"],
    ["บันทึกเฉพาะในอุปกรณ์นี้", "Saved only on this device"],
    ["ภูมิภาค", "Region"],
    ["ทั่วประเทศไทย", "All Thailand"],
    ["จำนวนวัน", "Days"],
    ["ผู้เดินทาง", "Travellers"],
    ["ความสนใจหลัก", "Main interest"],
    ["เที่ยวแบบหลากหลาย", "A varied trip"],
    ["ธรรมชาติ", "Nature"],
    ["ทะเลและเกาะ", "Beaches & islands"],
    ["ภูเขา", "Mountains"],
    ["วัดและประวัติศาสตร์", "Temples & history"],
    ["วัฒนธรรมและอาหาร", "Culture & food"],
    ["จังหวะการเที่ยว", "Travel pace"],
    ["สบาย ๆ — พักจังหวัดละ 2 วัน", "Relaxed — stay two days per province"],
    ["สมดุล — ไม่เร่งเกินไป", "Balanced — comfortable pace"],
    ["เต็มที่ — จังหวัดใหม่ทุกวัน", "Active — a new province each day"],
    ["งบรวมโดยประมาณ (บาท)", "Estimated total budget (THB)"],
    ["ไม่บังคับ", "Optional"],
    ["สร้างแผนทริป", "Build itinerary"],
    ["เริ่มใหม่", "Start over"],
    ["หรือพิมพ์คำขอแบบด่วน", "Or type a quick request"],
