...
(function () {
  ...
  staticPairs.push(
    ["ท่องเที่ยว", "Travel"],
    ["โปรโมชั่นที่พัก", "Accommodation promotions"],
    ["ราคาในหน้านี้เป็นข้อมูลตัวอย่างสำหรับโครงงาน ไม่ใช่ข้อเสนอจากผู้ให้บริการจริง ส่วนชื่อจังหวัดและรูปภาพเชื่อมจากข้อมูลสถานที่ชุดกลาง", "Prices on this page are portfolio samples, not real provider offers. Province names and images come from the shared destination data."],
    ["แพ็กเกจท่องเที่ยว", "Travel packages"],
    ["แพ็กเกจและราคาเป็นตัวอย่างสำหรับแสดงการทำงานของเว็บไซต์ โดยสถานที่ รายละเอียด และภาพอ้างอิงจากฐานข้อมูลจังหวัดเดียวกัน", "Packages and prices demonstrate the website. Places, details and images resolve from the same province records."],
